...
export const MODERN_ELITE_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'me_19', name: '火雁', url: 'gym/火雁.webp', coreUnits: ['flareon', 'cyndaquil', 'vulpix', 'sneasel', 'murkrow'], difficulty: 'VERY_HARD' },
    { id: 'me_20', name: '阿泉', url: 'gym/阿泉.webp', coreUnits: ['vaporeon', 'totodile', 'squirtle', 'sneasel', 'murkrow'], difficulty: 'VERY_HARD' },
    { id: 'me_21', name: '牡丹', url: 'gym/牡丹.webp', coreUnits: ['flareon', 'jolteon', 'umbreon', 'leafeon', 'espeon'], difficulty: 'VERY_HARD' },
    { id: 'me_22', name: '琉琪亞', url: 'gym/琉琪亞.webp', coreUnits: ['vaporeon', 'espeon', 'umbreon', 'glaceon', 'sylveon'], difficulty: 'VERY_HARD' },
    { id: 'me_23', name: '竹蘭01', url: 'champion/竹蘭01.webp', coreUnits: ['mareep', 'shuckle', 'sneasel', 'murkrow', 'togepi'], difficulty: 'VERY_HARD' },
