...
export const NOVICE_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'novice_3', name: '小剛', url: 'gym/小剛01.webp', coreUnits: ['dwebble', 'dwebble', 'diglett'], difficulty: 'HARD' },
...
export const INTERM_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'interm_2', name: '小遙', url: 'gym/小遙01.webp', coreUnits: ['torchic', 'mudkip'], difficulty: 'NORMAL' },
    { id: 'interm_3', name: '滿充', url: 'gym/滿充01.webp', coreUnits: ['ralts', 'igglybuff', 'magnemite'], difficulty: 'VERY_HARD' },
    { id: 'interm_4', name: '小剛', url: 'gym/小剛02.webp', coreUnits: ['mudkip', 'diglett', 'dwebble'], difficulty: 'NORMAL' },
    { id: 'interm_5', name: '小霞', url: 'gym/小霞02.webp', coreUnits: ['squirtle', 'totodile', 'slowpoke'], difficulty: 'HARD' },
    { id: 'interm_6', name: '青綠', url: 'gym/青綠02.webp', coreUnits: ['squirtle', 'charmander', 'bulbasaur', 'doduo', 'rattata'], difficulty: 'HARD' },
    { id: 'interm_7', name: '梅麗莎', url: 'gym/梅麗莎.webp', coreUnits: ['shuppet', 'drifloon', 'gastly', 'gastly'], difficulty: 'HARD' },
    { id: 'interm_8', name: '亞莎', url: 'gym/亞莎.webp', coreUnits: ['torchic', 'houndour', 'cyndaquil'], difficulty: 'HARD' },
    { id: 'interm_9', name: '阿四', url: 'gym/阿四.webp', coreUnits: ['bewear', 'pinsir', 'heracross'], difficulty: 'NORMAL' },
    ...
    { id: 'interm_12', name: '希特隆', url: 'gym/希特隆.webp', coreUnits: ['magnemite', 'magnemite', 'doduo', 'diglett'], difficulty: 'HARD' },
    ...
    { id: 'interm_16', name: '小南', url: 'gym/小南.webp', coreUnits: ['natu', 'natu', 'slowpoke'], difficulty: 'NORMAL' },
    ...
    { id: 'interm_20', name: '格拉吉歐', url: 'gym/格拉吉歐01.webp', coreUnits: ['charmander', 'gastly', 'houndour'], difficulty: 'VERY_HARD' },
];

export const ADVANCED_OPPONENTS: OpponentDefinition[] = [
    { id: 'adv_1', name: '坂木', url: 'gym/坂木.webp', coreUnits: ['meowth', 'bewear', 'kangaskhan', 'kangaskhan', 'onix'], difficulty: 'HARD' },
    { id: 'adv_2', name: '小菘', url: 'gym/小菘.webp', coreUnits: ['snover', 'snover', 'sneasel'], difficulty: 'HARD' },
    { id: 'adv_3', name: '阿蜜', url: 'gym/阿蜜.webp', coreUnits: ['magnemite', 'magnemite', 'onix', 'onix'], difficulty: 'HARD' },
    { id: 'adv_4', name: '千里', url: 'gym/千里.webp', coreUnits: ['kangaskhan', 'kangaskhan', 'rattata'], difficulty: 'NORMAL' },
    ...
    { id: 'adv_9', name: '瑪綉', url: 'gym/瑪綉.webp', coreUnits: ['igglybuff', 'igglybuff', 'ralts', 'natu', 'slowpoke'], difficulty: 'HARD' },
    { id: 'adv_10', name: '小智', url: 'gym/小智.webp', coreUnits: ['bulbasaur', 'treecko', 'gastly', 'cyndaquil', 'charmander'], difficulty: 'NORMAL' },
    ...
    { id: 'adv_15', name: '阿響', url: 'gym/阿響02.webp', coreUnits: ['charmander', 'cyndaquil', 'gastly'], difficulty: 'NORMAL' },
    { id: 'adv_16', name: '滿充', url: 'gym/滿充02.webp', coreUnits: ['ralts', 'sprigatito'], difficulty: 'VERY_HARD' },
    { id: 'adv_17', name: '小遙', url: 'gym/小遙02.webp', coreUnits: ['torchic', 'torchic', 'mudkip', 'ralts', 'igglybuff'], difficulty: 'VERY_HARD' },
    { id: 'adv_18', name: '小悠', url: 'gym/小悠02.webp', coreUnits: ['rattata', 'meowth', 'mudkip', 'treecko', 'treecko'], difficulty: 'VERY_HARD' },
    { id: 'adv_19', name: '格拉吉歐', url: 'gym/格拉吉歐02.webp', coreUnits: ['sneasel', 'sprigatito', 'houndour'], difficulty: 'VERY_HARD' },
];

export const ELITE_OPPONENTS: OpponentDefinition[] = [
    { id: 'elite_1', name: '竹蘭', url: 'champion/竹蘭01.webp', coreUnits: ['spiritomb', 'igglybuff', 'drifloon', 'mimikyu', 'gastly'], difficulty: 'VERY_HARD' },
    { id: 'elite_2', name: '卡露妮', url: 'champion/卡露妮01.webp', coreUnits: ['ralts', 'natu', 'slowpoke', 'igglybuff', 'igglybuff'], difficulty: 'NORMAL' },
    { id: 'elite_3', name: '阿渡', url: 'elitefour/阿渡01.webp', coreUnits: ['doduo', 'magnemite', 'diglett', 'charmander', 'onix'], difficulty: 'HARD' },
    { id: 'elite_4', name: '大吾', url: 'champion/大吾01.webp', coreUnits: ['dwebble', 'onix', 'mudkip', 'magnemite', 'diglett'], difficulty: 'HARD' },
    { id: 'elite_5', name: '赤紅', url: 'champion/赤紅01.webp', coreUnits: ['charmander', 'squirtle', 'bulbasaur', 'slowpoke', 'farfetchd'], difficulty: 'NORMAL' },
    { id: 'elite_6', name: '丹帝', url: 'champion/丹帝01.webp', coreUnits: ['charmander', 'gastly', 'heracross', 'pinsir', 'drifloon'], difficulty: 'HARD' },
    { id: 'elite_7', name: '小智', url: 'gym/小智.webp', coreUnits: ['farfetchd', 'treecko', 'gastly', 'mrmime', 'charmander'], difficulty: 'NORMAL' },
    { id: 'elite_8', name: '柯拿', url: 'elitefour/科拿.webp', coreUnits: ['slowpoke', 'snover', 'sneasel', 'squirtle', 'quaxly'], difficulty: 'HARD' },
    { id: 'elite_9', name: '希巴', url: 'elitefour/希巴.webp', coreUnits: ['bewear', 'farfetchd', 'onix', 'heracross', 'pinsir'], difficulty: 'EASY' },
