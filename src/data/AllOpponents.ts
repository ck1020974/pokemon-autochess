...
export const INTERM_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'interm_3', name: '滿充', url: 'gym/滿充01.webp', coreUnits: ['ralts', 'igglybuff', 'magnemite'], difficulty: 'HARD' },
    ...
    { id: 'interm_8', name: '亞莎', url: 'gym/亞莎.webp', coreUnits: ['torchic', 'houndour', 'cyndaquil'], difficulty: 'VERY_HARD' },
    { id: 'interm_9', name: '阿四', url: 'gym/阿四.webp', coreUnits: ['mankey', 'pinsir', 'heracross'], difficulty: 'NORMAL' },
    { id: 'interm_10', name: '莉佳', url: 'gym/莉佳01.webp', coreUnits: ['bulbasaur', 'chikorita', 'snover'], difficulty: 'NORMAL' },
    { id: 'interm_11', name: '亞堤', url: 'gym/亞堤.webp', coreUnits: ['dwebble', 'dwebble', 'pinsir', 'heracross'], difficulty: 'HARD' },
    ...
    { id: 'interm_20', name: '格拉吉歐', url: 'gym/格拉吉歐01.webp', coreUnits: ['charmander', 'gastly', 'houndour'], difficulty: 'HARD' },
];
...
export const ADVANCED_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'adv_10', name: '小智', url: 'gym/小智.webp', coreUnits: ['bulbasaur', 'treecko', 'gastly', 'mankey', 'charmander'], difficulty: 'EASY' },
    { id: 'adv_11', name: '青綠', url: 'gym/青綠03.webp', coreUnits: ['charmander', 'squirtle', 'rattata', 'bulbasaur', 'doduo'], difficulty: 'EASY' },
...
export const ELITE_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'elite_15', name: '小霞', url: 'gym/小霞03.webp', coreUnits: ['mudkip', 'squirtle', 'slowpoke', 'totodile', 'quaxly'], difficulty: 'VERY_HARD' },
...
export const CHAMPION_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'champion_2', name: '卡露妮', url: 'champion/卡露妮02.webp', coreUnits: ['ralts', 'natu', 'slowpoke', 'igglybuff', 'mrmime'], difficulty: 'NORMAL' },
    { id: 'champion_3', name: '大吾', url: 'champion/大吾02.webp', coreUnits: ['dwebble', 'onix', 'mudkip', 'torchic', 'sableye'], difficulty: 'HARD' },
    ...
    { id: 'champion_5', name: '丹帝', url: 'champion/丹帝02.webp', coreUnits: ['charmander', 'gastly', 'heracross', 'farfetchd', 'drifloon'], difficulty: 'NORMAL' },
    { id: 'champion_6', name: '小智', url: 'gym/小智.webp', coreUnits: ['farfetchd', 'treecko', 'gastly', 'mrmime', 'charmander'], difficulty: 'EASY' },
    { id: 'champion_7', name: '赤焰松', url: 'elitefour/赤焰松.webp', coreUnits: ['houndour', 'shuppet', 'torchic', 'charmander', 'fuecoco'], difficulty: 'VERY_HARD' },
    { id: 'champion_8', name: '水梧桐', url: 'elitefour/水梧桐.webp', coreUnits: ['totodile', 'sneasel', 'mudkip', 'squirtle', 'quaxly'], difficulty: 'HARD' },
];
