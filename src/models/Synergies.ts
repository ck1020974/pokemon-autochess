...
export const SYNERGIES: Record<string, SynergyConfig> = {
    // --- Attributes ---
    'Starter': { id: 'Starter', name: '御三家', icon: '🌟', description: '[3/5] 準備結束時，永久 +1/2 攻擊與生命', tiers: [3, 5], color: '#fbbf24' },
    ...
    'Psychic': { id: 'Psychic', name: '念力', icon: '👁️', description: '[2/3/4] 兩回合後，對隨機 2/3/4 位敵方造成 2 點傷害 (每場對戰後增強)', tiers: [2, 3, 4], color: '#a855f7' },
