...
export const SYNERGIES: Record<string, SynergyConfig> = {
    ...
    'Fire': { id: 'Fire', name: '熱風', icon: '🔥', description: '[2/3/5] 攻擊前 -1 生命(最低為 1)， +2/4/10 攻擊', tiers: [2, 3, 5], color: '#ef4444' },
    ...
    'SwordDance': { id: 'SwordDance', name: '劍舞', icon: '⚔️', description: '[2] 移動後永久 +1 攻擊 (每場戰鬥限3次)', tiers: [2], color: '#fca5a5' },
    'Roost': { id: 'Roost', name: '羽棲', icon: '🪽', description: '[2] 移動後永久 +1 生命 (每場戰鬥限3次)', tiers: [2], color: '#bae6fd' },
    'Psychic': {
        id: 'Psychic',
        name: '念力',
        icon: '🔮',
    ...
    'Charge': { id: 'Charge', name: '電光', icon: '⚡', description: '[2/3/5] 戰鬥開始時，隨機增加 0~3/2~6/6~12 攻擊', tiers: [2, 3, 5], color: '#fde047' },
