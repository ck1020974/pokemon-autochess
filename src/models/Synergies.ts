...
export const SYNERGIES: Record<string, SynergyConfig> = {
    ...
    'Water': { id: 'Water', name: '潮汐', icon: '💧', description: '[2/3/4] 攻擊前使目標 -1/-3/-5 攻擊力 (最低為 1)', tiers: [2, 3, 4], color: '#60a5fa' },
    ...
    'Claw': { id: 'Claw', name: '利爪', icon: '🐯', description: '[2] 擊殺敵方後，永久 +3 攻擊', tiers: [2], color: '#fca5a5' },
    'Beetle': { id: 'Beetle', name: '甲蟲', icon: '🪲', description: '[2] 準備結束時，永久 +4 攻擊或生命', tiers: [2], color: '#b5e48c' },
