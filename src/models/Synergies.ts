...
export const SYNERGIES: Record<string, SynergyConfig> = {
    // --- Attributes ---
    'Starter': { id: 'Starter', name: '御三家', icon: '🌟', description: '[3/5] 準備結束時，永久 +1/3 攻擊與生命', tiers: [3, 5], color: '#fbbf24' },
    ...
    'Grass': { id: 'Grass', name: '吸取', icon: '🌿', description: '[2/3/4/5] 攻擊後回復 2/4/6/10 生命', tiers: [2, 3, 4, 5], color: '#4ade80' },
    'Fire': { id: 'Fire', name: '燃盡', icon: '🔥', description: '[2/3/4/5] 攻擊前 -1 生命(最低為 1)， +1/3/5/10 攻擊', tiers: [2, 3, 4, 5], color: '#ef4444' },
    'Water': { id: 'Water', name: '潮旋', icon: '💧', description: '[2/3/4/5] 攻擊前使目標 -1/2/3/5 攻擊力 (最低為 1)', tiers: [2, 3, 4, 5], color: '#60a5fa' },
    ...
    'Angry': { id: 'Angry', name: '憤怒', icon: '💢', description: '[2/3/4] 受傷後，全體友軍 +2/4/8 攻擊', tiers: [2, 3, 4], color: '#dc2626' },
    ...
    'Psychic': { id: 'Psychic', name: '念力', icon: '👁️', description: '[2/3/4] 兩回合後，對隨機 2/3/4 位敵方造成 N 點傷害 (每場對戰後增強)', tiers: [2, 3, 4], color: '#a855f7' },
