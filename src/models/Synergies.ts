...
export const SYNERGIES: Record<string, SynergyConfig> = {
    ...
    'Claw': { id: 'Claw', name: '磨爪', icon: '🐯', description: '[2] 擊殺敵方後，持有者永久 +2 攻擊', tiers: [2], color: '#fca5a5' },
    'Beetle': { id: 'Beetle', name: '甲蟲', icon: '🪲', description: '[2] 準備結束時，永久 +2 攻擊 與 生命', tiers: [2], color: '#b5e48c' },
    'Psychic': { id: 'Psychic', name: '念力', icon: '🪄', description: '[2] 兩回合後，對全體敵方造成一定傷害', tiers: [2], color: '#a855f7' },
