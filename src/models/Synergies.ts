...
export const SYNERGIES: Record<string, SynergyConfig> = {
    ...
    'Psychic': {
        ...
        icon: '🔮',
        color: '#a855f7',
        description: '[2/3/4] 兩回合後，對隨機 2 位敵方造成 2 傷害 (每場戰鬥後增強)',
        tiers: [2, 3, 4]
    },
    ...
    'Charge': { id: 'Charge', name: '充電', icon: '⚡', description: '[2/3/4/5] 戰鬥開始時，隨機增加 0~15 攻擊', tiers: [2, 3, 4, 5], color: '#fde047' },
    ...
    'BatonPass': { id: 'BatonPass', name: '接棒', icon: '🏃', description: '[2] 死亡後，隨機1位角色繼承33% 攻擊與生命', tiers: [2], color: '#fb923c' },
    'Outrage': { id: 'Outrage', name: '逆鱗', icon: '🐲', description: '[2/3] 攻擊前永久+3/5攻擊與生命，但攻擊有25%機率失效', tiers: [2, 3], color: '#f59e0b' },
};
