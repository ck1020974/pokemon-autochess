...
export const SYNERGIES: Record<string, SynergyConfig> = {
    ...
    'Normal': { id: 'Normal', name: '守住', icon: '⚪', description: '[2/3/4] 準備結束時，最前方友軍永久 +2/+4/+6 生命', tiers: [2, 3, 4], color: '#d1d5db' },
    'Ghost': { id: 'Ghost', name: '詛咒', icon: '👻', description: '[2/3/4] 準備結束時，最前方友軍永久 +2/+4/+6 攻擊', tiers: [2, 3, 4], color: '#a855f7' },
