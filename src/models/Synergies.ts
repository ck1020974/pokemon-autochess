...
export const SYNERGIES: Record<string, SynergyConfig> = {
    // --- Attributes ---
    'Starter': { id: 'Starter', name: '御三家', icon: '🌟', description: '[3] 戰鬥開始時，永久 +1 攻擊 或 生命', tiers: [3], color: '#fbbf24' },
    ...
    // --- Traits ---
    'Triplets': { id: 'Triplets', name: '三胞胎', icon: '👨‍👧‍👦', description: '[3] 戰鬥開始時， +3 攻擊 與 生命', tiers: [3], color: '#fcd34d' },
    'Angry': { id: 'Angry', name: '憤怒', icon: '💢', description: '[2] 受傷後 +3 攻擊', tiers: [2], color: '#dc2626' },
    'Slow': { id: 'Slow', name: '遲鈍', icon: '🌀', description: '[2] 所受到的傷害減少33% (最低為 1)', tiers: [2], color: '#f87171' },
    ...
    'Beetle': { id: 'Beetle', name: '甲蟲', icon: '🪲', description: '[2] 準備結束時，永久 +5 生命 或 攻擊（優先加較低的該項能力）', tiers: [2], color: '#b5e48c' },
