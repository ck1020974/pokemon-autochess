...
export const UNIT_TEMPLATES: Record<string, UnitTemplate> = {
    ...
    charmander: {
        ...
        description: '攻擊時，對敵方後排造成 [N] 傷害 (三場戰鬥後增強)。', synergies: ['Starter', 'Fire'], evolveId: 'charmeleon'
    },
    charmeleon: {
        id: 'charmeleon', name: '火恐龍', tier: 1, family: 'charmander',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: 'assets/火恐龍00.webp', battleImageUrl: 'assets/火恐龍01.webp',
        description: '攻擊時，對敵方後排造成 [N] 傷害 (兩場戰鬥後增強)。', synergies: ['Starter', 'Fire'], evolveId: 'charizard', isHiddenFromShop: true
    },
    charizard: {
        id: 'charizard', name: '噴火龍', tier: 1, family: 'charmander',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: 'assets/噴火龍00.webp', battleImageUrl: 'assets/噴火龍01.webp',
        description: '攻擊時，對敵方後排造成 [N] 傷害 (每場戰鬥後增強)。', synergies: ['Starter', 'Fire'], isHiddenFromShop: true
    },
    ...
    spiritomb: {
        ...
        description: '戰鬥開始時，使 2 個敵方角色的招式無效化。', synergies: ['Ghost', 'Angry']
    },
    heracross: {
