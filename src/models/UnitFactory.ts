...
export const UNIT_TEMPLATES: Record<string, UnitTemplate> = {
    ...
    bulbasaur: {
        ...
        imageUrl: '/src/assets/妙蛙種子00.webp', battleImageUrl: '/src/assets/妙蛙種子01.webp',
        description: '死亡後召喚 1 隻 1/1 小種子。', synergies: ['Starter', 'Grass'], evolveId: 'ivysaur'
    },
    ivysaur: {
        id: 'ivysaur', name: '妙蛙草', tier: 1, family: 'bulbasaur',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/妙蛙草00.webp', battleImageUrl: '/src/assets/妙蛙草01.webp',
    ...
    venusaur: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/妙蛙花00.webp', battleImageUrl: '/src/assets/妙蛙花01.webp',
    ...
    charmander: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/小火龍00.webp', battleImageUrl: '/src/assets/小火龍01.webp',
    ...
    charmeleon: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/火恐龍00.webp', battleImageUrl: '/src/assets/火恐龍01.webp',
    ...
    charizard: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/噴火龍00.webp', battleImageUrl: '/src/assets/噴火龍01.webp',
    ...
    squirtle: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/傑尼龜00.webp', battleImageUrl: '/src/assets/傑尼龜01.webp',
        description: '受到的傷害減少 1 (最低為 1)。', synergies: ['Starter', 'Water'], evolveId: 'wartortle'
    },
    wartortle: {
        id: 'wartortle', name: '卡咪龜', tier: 1, family: 'squirtle',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/卡咪龜00.webp', battleImageUrl: '/src/assets/卡咪龜01.webp',
    ...
    blastoise: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/水箭龜00.webp', battleImageUrl: '/src/assets/水箭龜01.webp',
    ...
    chikorita: {
        ...
        imageUrl: '/src/assets/菊草葉00.webp', battleImageUrl: '/src/assets/菊草葉01.webp',
        description: '友軍召喚物 +1 攻擊 與 生命。', synergies: ['Starter', 'Grass'], evolveId: 'bayleef'
    },
    bayleef: {
        id: 'bayleef', name: '月桂葉', tier: 2, family: 'chikorita',
        baseStats: { hp: 4, maxHp: 4, attack: 2 },
        imageUrl: '/src/assets/月桂葉00.webp', battleImageUrl: '/src/assets/月桂葉01.webp',
    ...
    meganium: {
        ...
        baseStats: { hp: 4, maxHp: 4, attack: 2 },
        imageUrl: '/src/assets/大竺葵00.webp', battleImageUrl: '/src/assets/大竺葵01.webp',
    ...
    cyndaquil: {
        ...
        imageUrl: '/src/assets/火球鼠00.webp', battleImageUrl: '/src/assets/火球鼠01.webp',
    ...
    quilava: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/火岩鼠00.webp', battleImageUrl: '/src/assets/火岩鼠01.webp',
    ...
    typhlosion: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/火爆獸00.webp', battleImageUrl: '/src/assets/火爆獸01.webp',
    ...
    totodile: {
        ...
        imageUrl: '/src/assets/小鋸鱷00.webp', battleImageUrl: '/src/assets/小鋸鱷01.webp',
        description: '攻擊時，同時對後排敵人造成 2 傷害。', synergies: ['Starter', 'Water'], evolveId: 'croconaw'
    },
    croconaw: {
        id: 'croconaw', name: '藍鱷', tier: 2, family: 'totodile',
        baseStats: { hp: 2, maxHp: 2, attack: 4 },
        imageUrl: '/src/assets/藍鱷00.webp', battleImageUrl: '/src/assets/藍鱷01.webp',
    ...
    feraligatr: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 4 },
        imageUrl: '/src/assets/大力鱷00.webp', battleImageUrl: '/src/assets/大力鱷01.webp',
    ...
    igglybuff: {
        ...
        imageUrl: '/src/assets/寶寶丁00.webp', battleImageUrl: '/src/assets/寶寶丁01.webp',
        description: '合成時前方友軍 +2 生命。', synergies: ['Normal'], evolveId: 'jigglypuff'
    },
    jigglypuff: {
        id: 'jigglypuff', name: '胖丁', tier: 1, family: 'igglybuff',
        baseStats: { hp: 3, maxHp: 3, attack: 1 },
        imageUrl: '/src/assets/胖丁00.webp', battleImageUrl: '/src/assets/胖丁01.webp',
    ...
    wigglytuff: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 1 },
        imageUrl: '/src/assets/胖可丁00.webp', battleImageUrl: '/src/assets/胖可丁01.webp',
    ...
    treecko: {
        ...
        imageUrl: '/src/assets/木守宮00.webp', battleImageUrl: '/src/assets/木守宮01.webp',
        description: '召喚友軍後對首位敵方造成 2 傷害。', synergies: ['Starter', 'Grass'], evolveId: 'grovyle'
    },
    grovyle: {
        id: 'grovyle', name: '森林蜥蜴', tier: 3, family: 'treecko',
        baseStats: { hp: 4, maxHp: 4, attack: 4 },
        imageUrl: '/src/assets/森林蜥蜴00.webp', battleImageUrl: '/src/assets/森林蜥蜴01.webp',
    ...
    sceptile: {
        ...
        baseStats: { hp: 4, maxHp: 4, attack: 4 },
        imageUrl: '/src/assets/蜥蜴王00.webp', battleImageUrl: '/src/assets/蜥蜴王01.webp',
    ...
    torchic: {
        ...
        imageUrl: '/src/assets/火稚雞00.webp', battleImageUrl: '/src/assets/火稚雞01.webp',
        description: '前方友軍攻擊時，對目標造成 2 傷害。', synergies: ['Starter', 'Fire'], evolveId: 'combusken'
    },
    combusken: {
        id: 'combusken', name: '力壯雞', tier: 3, family: 'torchic',
        baseStats: { hp: 3, maxHp: 3, attack: 5 },
        imageUrl: '/src/assets/力壯雞00.webp', battleImageUrl: '/src/assets/力壯雞01.webp',
    ...
    blaziken: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 5 },
        imageUrl: '/src/assets/火焰雞00.webp', battleImageUrl: '/src/assets/火焰雞01.webp',
    ...
    mudkip: {
        ...
        imageUrl: '/src/assets/水躍魚00.webp', battleImageUrl: '/src/assets/水躍魚01.webp',
        description: '戰鬥開始時，前方友軍增加 3 生命 與 攻擊。', synergies: ['Starter', 'Water'], evolveId: 'marshtomp'
    },
    marshtomp: {
        id: 'marshtomp', name: '沼躍魚', tier: 3, family: 'mudkip',
        baseStats: { hp: 5, maxHp: 5, attack: 3 },
        imageUrl: '/src/assets/沼躍魚00.webp', battleImageUrl: '/src/assets/沼躍魚01.webp',
    ...
    swampert: {
        ...
        baseStats: { hp: 5, maxHp: 5, attack: 3 },
        imageUrl: '/src/assets/巨沼怪00.webp', battleImageUrl: '/src/assets/巨沼怪01.webp',
    ...
    sprigatito: {
        ...
        imageUrl: '/src/assets/新葉喵00.webp', battleImageUrl: '/src/assets/新葉喵01.webp',
    ...
    floragato: {
        ...
        baseStats: { hp: 5, maxHp: 5, attack: 5 },
        imageUrl: '/src/assets/蒂蕾喵00.webp', battleImageUrl: '/src/assets/蒂蕾喵01.webp',
    ...
    meowscarada: {
        ...
        baseStats: { hp: 5, maxHp: 5, attack: 5 },
        imageUrl: '/src/assets/魔幻假面喵00.webp', battleImageUrl: '/src/assets/魔幻假面喵01.webp',
    ...
    fuecoco: {
        ...
        imageUrl: '/src/assets/呆火鱷00.webp', battleImageUrl: '/src/assets/呆火鱷01.webp',
        description: '友軍死亡後，自身獲得 +3 生命。', synergies: ['Starter', 'Fire'], evolveId: 'crocalor'
    },
    crocalor: {
        id: 'crocalor', name: '炙燙鱷', tier: 4, family: 'fuecoco',
        baseStats: { hp: 6, maxHp: 6, attack: 4 },
        imageUrl: '/src/assets/炙燙鱷00.webp', battleImageUrl: '/src/assets/炙燙鱷01.webp',
    ...
    skeledirge: {
        ...
        baseStats: { hp: 6, maxHp: 6, attack: 4 },
        imageUrl: '/src/assets/骨紋巨聲鱷00.webp', battleImageUrl: '/src/assets/骨紋巨聲鱷01.webp',
    ...
    quaxly: {
        ...
        imageUrl: '/src/assets/潤水鴨00.webp', battleImageUrl: '/src/assets/潤水鴨01.webp',
        description: '擊殺敵方後，自身獲得 +3 攻擊。', synergies: ['Starter', 'Water'], evolveId: 'quaxwell'
    },
    quaxwell: {
        id: 'quaxwell', name: '湧躍鴨', tier: 4, family: 'quaxly',
        baseStats: { hp: 4, maxHp: 4, attack: 6 },
        imageUrl: '/src/assets/湧躍鴨00.webp', battleImageUrl: '/src/assets/湧躍鴨01.webp',
    ...
    quaquaval: {
        ...
        baseStats: { hp: 4, maxHp: 4, attack: 6 },
        imageUrl: '/src/assets/狂歡浪舞鴨00.webp', battleImageUrl: '/src/assets/狂歡浪舞鴨01.webp',
    ...
    rattata: {
        ...
        imageUrl: '/src/assets/小拉達00.webp', battleImageUrl: '/src/assets/小拉達01.webp',
        description: '死亡後召喚 2 隻 1/1 迷你拉達。', synergies: ['Normal'], evolveId: 'raticate'
    },
    raticate: {
        id: 'raticate', name: '拉達', tier: 1, family: 'rattata',
        baseStats: { hp: 1, maxHp: 1, attack: 1 },
        imageUrl: '/src/assets/拉達00.webp', battleImageUrl: '/src/assets/拉達01.webp',
    ...
    diglett: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/地鼠00.webp', battleImageUrl: '/src/assets/地鼠01.webp',
        description: '有 25% 機率閃避傷害。', synergies: ['Triplets', 'Cave'], evolveId: 'dugtrio'
    },
    dugtrio: {
        id: 'dugtrio', name: '三地鼠', tier: 2, family: 'diglett',
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/三地鼠00.webp', battleImageUrl: '/src/assets/三地鼠01.webp',
    ...
    meowth: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/喵喵00.webp', battleImageUrl: '/src/assets/喵喵01.webp',
        description: '回合開始時獲得 1 金幣。', synergies: ['Normal', 'Claw'], evolveId: 'persian'
    },
    persian: {
        id: 'persian', name: '貓老大', tier: 2, family: 'meowth',
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/貓老大00.webp', battleImageUrl: '/src/assets/貓老大01.webp',
    ...
    mankey: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/猴怪00.webp', battleImageUrl: '/src/assets/猴怪01.webp',
        description: '戰鬥開始時，前方友軍獲得 +2 攻擊。', synergies: ['Angry'], evolveId: 'primeape'
    },
    primeape: {
        id: 'primeape', name: '火爆猴', tier: 1, family: 'mankey',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/火爆猴00.webp', battleImageUrl: '/src/assets/火爆猴01.webp',
    ...
    onix: {
        ...
        baseStats: { hp: 5, maxHp: 5, attack: 5 },
        imageUrl: '/src/assets/大岩蛇00.webp', battleImageUrl: '/src/assets/大岩蛇01.webp',
        description: '移動後，永久 +2 生命；反彈 50% 所受到的傷害。', synergies: ['Cave', 'Hard'], evolveId: 'steelix'
    },
    steelix: {
        id: 'steelix', name: '大鋼蛇', tier: 4, family: 'onix',
        baseStats: { hp: 5, maxHp: 5, attack: 5 },
        imageUrl: '/src/assets/大鋼蛇00.webp', battleImageUrl: '/src/assets/大鋼蛇01.webp',
    ...
    doduo: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/嘟嘟00.webp', battleImageUrl: '/src/assets/嘟嘟01.webp',
        description: '有 25% 機率額外攻擊一次。', synergies: ['Triplets', 'Angry'], evolveId: 'dodrio'
    },
    dodrio: {
        id: 'dodrio', name: '嘟嘟利', tier: 2, family: 'doduo',
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/嘟嘟利00.webp', battleImageUrl: '/src/assets/嘟嘟利01.webp',
    ...
    slowpoke: {
        ...
        baseStats: { hp: 4, maxHp: 4, attack: 4 },
        imageUrl: '/src/assets/呆呆獸00.webp', battleImageUrl: '/src/assets/呆呆獸01.webp',
        description: '受傷時，若生命 < 50%，回復 6 生命 (每場戰鬥 1 次)。', synergies: ['Slow', 'Water'], evolveId: 'slowbro'
    },
    slowbro: {
        id: 'slowbro', name: '呆殼獸', tier: 3, family: 'slowpoke',
        baseStats: { hp: 4, maxHp: 4, attack: 4 },
        imageUrl: '/src/assets/呆殼獸00.webp', battleImageUrl: '/src/assets/呆殼獸01.webp',
    ...
    magnemite: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/小磁怪00.webp', battleImageUrl: '/src/assets/小磁怪01.webp',
    ...
    magneton: {
        ...
        baseStats: { hp: 1, maxHp: 1, attack: 1 },
        imageUrl: '/src/assets/三合一磁怪00.webp', battleImageUrl: '/src/assets/三合一磁怪01.webp',
    ...
    houndour: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/戴魯比00.webp', battleImageUrl: '/src/assets/戴魯比01.webp',
        description: '戰鬥開始時，對生命最少敵方造成 4 傷害 (共 1 次)。', synergies: ['Angry', 'Fire'], evolveId: 'houndoom'
    },
    houndoom: {
        id: 'houndoom', name: '黑魯加', tier: 3, family: 'houndour',
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/黑魯加00.webp', battleImageUrl: '/src/assets/黑魯加01.webp',
    ...
    sneasel: {
        ...
        baseStats: { hp: 5, maxHp: 5, attack: 5 },
        imageUrl: '/src/assets/狃拉00.webp', battleImageUrl: '/src/assets/狃拉01.webp',
        description: '攻擊時，再隨機攻擊 1 個敵方；擊殺後攻擊永久 +3。', synergies: ['Claw', 'Snow'], evolveId: 'weavile'
    },
    weavile: {
        id: 'weavile', name: '瑪狃拉', tier: 4, family: 'sneasel',
        baseStats: { hp: 5, maxHp: 5, attack: 5 },
        imageUrl: '/src/assets/瑪狃拉00.webp', battleImageUrl: '/src/assets/瑪狃拉01.webp',
    ...
    shuppet: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/怨影娃娃00.webp', battleImageUrl: '/src/assets/怨影娃娃01.webp',
        description: '死亡後對隨機敵方造成 2 傷害。', synergies: ['Ghost'], evolveId: 'banette'
    },
    banette: {
        id: 'banette', name: '詛咒娃娃', tier: 1, family: 'shuppet',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/詛咒娃娃00.webp', battleImageUrl: '/src/assets/詛咒娃娃01.webp',
    ...
    drifloon: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/飄飄球00.webp', battleImageUrl: '/src/assets/飄飄球01.webp',
        description: '死亡後對全體敵方造成 2 傷害。', synergies: ['Ghost'], evolveId: 'drifblim'
    },
    drifblim: {
        id: 'drifblim', name: '隨風球', tier: 2, family: 'drifloon',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/隨風球00.webp', battleImageUrl: '/src/assets/隨風球01.webp',
    ...
    snover: {
        ...
        baseStats: { hp: 6, maxHp: 6, attack: 4 },
        imageUrl: '/src/assets/雪笠怪00.webp', battleImageUrl: '/src/assets/雪笠怪01.webp',
        description: '攻擊後 +1 攻擊並擊退敵方角色。', synergies: ['Grass', 'Snow'], evolveId: 'abomasnow'
    },
    abomasnow: {
        id: 'abomasnow', name: '暴雪王', tier: 3, family: 'snover',
        baseStats: { hp: 6, maxHp: 6, attack: 4 },
        imageUrl: '/src/assets/暴雪王00.webp', battleImageUrl: '/src/assets/暴雪王01.webp',
    ...
    dwebble: {
        ...
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/石居蟹00.webp', battleImageUrl: '/src/assets/石居蟹01.webp',
        description: '戰鬥開始時，前方友軍 +2 生命。', synergies: ['Hard'], evolveId: 'crustle'
    },
    crustle: {
        id: 'crustle', name: '岩殿居蟹', tier: 1, family: 'dwebble',
        baseStats: { hp: 2, maxHp: 2, attack: 2 },
        imageUrl: '/src/assets/岩殿居蟹00.webp', battleImageUrl: '/src/assets/岩殿居蟹01.webp',
    ...
    kangaskhan: {
        ...
        imageUrl: '/src/assets/袋獸00.webp', battleImageUrl: '/src/assets/袋獸01.webp',
    ...
    ditto: {
        ...
        imageUrl: '/src/assets/百變怪00.webp', battleImageUrl: '/src/assets/百變怪01.webp',
    ...
    sableye: {
        ...
        baseStats: { hp: 5, maxHp: 5, attack: 5 },
        imageUrl: '/src/assets/勾魂眼00.webp', battleImageUrl: '/src/assets/勾魂眼01.webp',
    ...
    mimikyu: {
        ...
        baseStats: { hp: 10, maxHp: 10, attack: 10 },
        imageUrl: '/src/assets/謎擬Ｑ00.webp', battleImageUrl: '/src/assets/謎擬Ｑ01.webp',
    ...
    spiritomb: {
        ...
        baseStats: { hp: 10, maxHp: 10, attack: 10 },
        imageUrl: '/src/assets/花岩怪00.webp', battleImageUrl: '/src/assets/花岩怪01.webp',
    ...
    gulpin: {
        ...
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/溶食獸00.webp', battleImageUrl: '/src/assets/溶食獸01.webp',
        description: '戰鬥開始時，吞噬前方友軍並繼承其生命和攻擊。', synergies: ['Slow'], evolveId: 'swalot'
    },
    swalot: {
        id: 'swalot', name: '吞食獸', tier: 2, family: 'gulpin',
        baseStats: { hp: 3, maxHp: 3, attack: 3 },
        imageUrl: '/src/assets/吞食獸00.webp', battleImageUrl: '/src/assets/吞食獸01.webp',
    ...
    heracross: {
        ...
        baseStats: { hp: 4, maxHp: 4, attack: 4 },
        imageUrl: '/src/assets/赫拉克羅斯00.webp', battleImageUrl: '/src/assets/赫拉克羅斯01.webp',
        description: '首次受傷後，本場戰鬥中攻擊力翻倍。', synergies: ['Beetle']
    },
    pinsir: {
        id: 'pinsir', name: '凱羅斯', tier: 3, family: 'pinsir',
        baseStats: { hp: 4, maxHp: 4, attack: 4 },
        imageUrl: '/src/assets/凱羅斯00.webp', battleImageUrl: '/src/assets/凱羅斯01.webp',
        description: '攻擊無視減傷、堅硬及謎擬Q的技能效果。', synergies: ['Beetle']
    },
    farfetchd: {
        id: 'farfetchd', name: '大蔥鴨', tier: 5, family: 'farfetchd',
        baseStats: { hp: 10, maxHp: 10, attack: 10 },
        imageUrl: '/src/assets/大蔥鴨00.webp', battleImageUrl: '/src/assets/大蔥鴨01.webp',
