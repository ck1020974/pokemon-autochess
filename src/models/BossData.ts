...
export const INTERM_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'interm_9', name: '阿四', url: 'gym/阿四.webp', coreUnits: ['mankey', 'pinsir', 'heracross'], difficulty: 'NORMAL' },
    { id: 'interm_10', name: '莉佳', url: 'gym/莉佳.webp', coreUnits: ['bulbasaur', 'chikorita', 'snover'], difficulty: 'EASY' },
...
export const ADVANCED_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'adv_15', name: '阿響', url: 'gym/阿響02.webp', coreUnits: ['charmander', 'cyndaquil', 'mankey', 'gastly'], difficulty: 'NORMAL' },
...
export const ELITE_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'elite_3', name: '阿渡', url: 'elitefour/阿渡.webp', coreUnits: ['doduo', 'magnemite', 'diglett', 'charmander', 'onix'], difficulty: 'HARD' },
