...
export const NOVICE_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'novice_7', name: '阿響', url: 'gym/阿響01.webp', coreUnits: ['cyndaquil'], difficulty: 'EASY' },
...
export const INTERM_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'interm_5', name: '小霞', url: 'gym/小霞02.webp', coreUnits: ['squirtle', 'totodile', 'slowpoke'], difficulty: 'NORMAL' },
    ...
    { id: 'interm_11', name: '亞堤', url: 'gym/亞堤.webp', coreUnits: ['dwebble', 'dwebble', 'pinsir', 'heracross'], difficulty: 'EASY' },
    { id: 'interm_12', name: '希特隆', url: 'gym/希特隆.webp', coreUnits: ['magnemite', 'magnemite', 'doduo', 'diglett'], difficulty: 'HARD' },
    { id: 'interm_13', name: '阿筆', url: 'gym/阿筆.webp', coreUnits: ['pinsir', 'heracross', 'dwebble', 'dwebble'], difficulty: 'EASY' },
    ...
    { id: 'interm_19', name: '葉子', url: 'gym/葉子02.webp', coreUnits: ['bulbasaur', 'treecko', 'squirtle', 'slowpoke'], difficulty: 'NORMAL' },
    { id: 'interm_20', name: '格拉吉歐', url: 'gym/格拉吉歐01.webp', coreUnits: ['charmander', 'gastly', 'houndour'], difficulty: 'NORMAL' },
];

export const ADVANCED_OPPONENTS: OpponentDefinition[] = [
    { id: 'adv_1', name: '坂木', url: 'gym/坂木.webp', coreUnits: ['meowth', 'mankey', 'kangaskhan', 'kangaskhan', 'onix'], difficulty: 'NORMAL' },
    ...
    { id: 'adv_5', name: '小青', url: 'gym/小青.webp', coreUnits: ['sprigatito', 'fuecoco'], difficulty: 'EASY' },
    ...
    { id: 'adv_8', name: '歐尼奧', url: 'gym/歐尼奧.webp', coreUnits: ['mimikyu', 'gastly', 'gastly', 'shuppet'], difficulty: 'NORMAL' },
    ...
    { id: 'adv_12', name: '小銀', url: 'gym/小銀.webp', coreUnits: ['cyndaquil', 'chikorita', 'totodile', 'sneasel', 'magnemite'], difficulty: 'NORMAL' },
    ...
    { id: 'adv_18', name: '小悠', url: 'gym/小悠02.webp', coreUnits: ['rattata', 'meowth', 'mudkip', 'treecko', 'treecko'], difficulty: 'HARD' },
...
export const ELITE_OPPONENTS: OpponentDefinition[] = [
    ...
    { id: 'elite_3', name: '阿渡', url: 'elitefour/阿渡.webp', coreUnits: ['doduo', 'magnemite', 'diglett', 'charmander', 'onix'], difficulty: 'NORMAL' },
    ...
    { id: 'elite_17', name: '水梧桐', url: 'elitefour/水梧桐.webp', coreUnits: ['totodile', 'sneasel', 'mudkip', 'squirtle', 'quaxly'], difficulty: 'HARD' },
